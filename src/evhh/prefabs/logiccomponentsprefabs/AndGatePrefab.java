 ...
 * @time: 10:06
 **********************************************************************************************************************/
public class AndGatePrefab extends ObjectPrefab
{
    transient private BufferedImage activeTexture;
    private String activeTextureRef;
    public AndGatePrefab(BufferedImage inactiveTexture,
    ...
    public GameObject getInstance(Grid grid, int x, int y)
    {
        ...
        BoolLogicComponent blc = new BoolLogicComponent(instance,cc,BoolLogicComponent.AND_2);
