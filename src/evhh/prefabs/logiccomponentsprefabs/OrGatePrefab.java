 ...
 * @time: 10:07
 **********************************************************************************************************************/
public class OrGatePrefab extends ObjectPrefab
{
    transient private BufferedImage activeTexture;
    private String activeTextureRef;
    public OrGatePrefab(BufferedImage inactiveTexture,
    ...
    public GameObject getInstance(Grid grid, int x, int y)
    {
        ...
        BoolLogicComponent blc = new BoolLogicComponent(instance,cc,BoolLogicComponent.OR);
